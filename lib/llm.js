...
// Client factory is injectable for tests. By default it dynamically imports
// the real SDK and constructs a client.
...
export function __setClientFactory(fn) {
  clientFactory = fn;
}
